...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-demo-box"] = factory();
	else
		root["vue-demo-box"] = factory();
...
// module
exports.push([module.i, ".db__wrapper{position:relative;display:inline-block;width:100%;margin:0 0 16px;border:1px solid #ebedf0;border-radius:4px;overflow:hidden}.db__demo{padding:42px 24px;color:rgba(0,0,0,.65);border-bottom:1px solid #ebedf0}.db__meta{position:relative;width:100%;font-size:14px;line-height:1.8;color:#314659}.db__wrapper--expand .db__meta{border-bottom:1px dashed #ebedf0}.db__title{position:absolute;top:-14px;margin-left:16px;padding:0 8px;color:#777;background:#fff}.db__description{padding:18px 24px 12px;border-bottom:1px dashed #ebedf0}.db__description p{margin:0}.db__icon{display:inline-block;width:30px;height:30px;overflow:hidden;text-indent:-9999px;background-repeat:no-repeat;background-position:50%;background-size:18px;cursor:pointer}.db__icon-jsfiddle{background-image:url(" + escape(__webpack_require__("3578")) + ")}.db__icon-codepen{background-image:url(" + escape(__webpack_require__("db1b")) + ")}.db__icon-code{background-image:url(" + escape(__webpack_require__("6a6c")) + ")}.db__actions{padding:4px 0;text-align:center;opacity:.7;-webkit-transition:opacity .3s;transition:opacity .3s}.db__actions:hover{opacity:1}.db__actions .db__icon{margin:0 10px;vertical-align:top;-webkit-transition:-webkit-transform .2s;transition:-webkit-transform .2s;transition:transform .2s;transition:transform .2s,-webkit-transform .2s}.db__actions .db__icon:hover{-webkit-transform:scale(1.1);transform:scale(1.1)}.db__code-trans-enter-active,.db__code-trans-leave-active{opacity:1;-webkit-transform:scaleY(1);transform:scaleY(1);-webkit-transition:opacity .3s cubic-bezier(.23,1,.32,1),-webkit-transform .3s cubic-bezier(.23,1,.32,1);transition:opacity .3s cubic-bezier(.23,1,.32,1),-webkit-transform .3s cubic-bezier(.23,1,.32,1);transition:transform .3s cubic-bezier(.23,1,.32,1),opacity .3s cubic-bezier(.23,1,.32,1);transition:transform .3s cubic-bezier(.23,1,.32,1),opacity .3s cubic-bezier(.23,1,.32,1),-webkit-transform .3s cubic-bezier(.23,1,.32,1);-webkit-transform-origin:center top;transform-origin:center top}.db__code-trans-enter,.db__code-trans-leave-active{opacity:0;-webkit-transform:scaleY(0);transform:scaleY(0)}.db__code div[class*=language-]{border-radius:0}.db__code div[class*=language-] pre[class*=language-]{margin:0}", ""]);
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_style_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("f72e");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_style_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_style_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_style_css_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// load the styles
var content = __webpack_require__("b444");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("183d3ca4", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"91719628-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/DemoBox.vue?vue&type=template&id=e571b3bc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"db__wrapper",class:{ 'db__wrapper--expand': _vm.expand }},[_c('div',{staticClass:"db__demo"},[_vm._t("demo")],2),_c('div',{staticClass:"db__meta"},[(_vm.title)?_c('div',{staticClass:"db__title"},[_vm._v(_vm._s(_vm.title))]):_vm._e(),(_vm.$slots.default)?_c('div',{staticClass:"db__description"},[_vm._t("default")],2):_vm._e(),_c('div',{staticClass:"db__actions"},[(_vm.finalPlatform.jsfiddle)?_c('div',{staticClass:"db__icon db__icon-jsfiddle",attrs:{"title":"jsfiddle"},on:{"click":function($event){return _vm.jumpTo('jsfiddle')}}}):_vm._e(),(_vm.finalPlatform.codepen)?_c('div',{staticClass:"db__icon db__icon-codepen",attrs:{"title":"codepen"},on:{"click":function($event){return _vm.jumpTo('codepen')}}}):_vm._e(),(_vm.$slots.code)?_c('div',{staticClass:"db__icon db__icon-code",attrs:{"title":"code"},on:{"click":function($event){_vm.expand = !_vm.expand}}}):_vm._e()])]),(_vm.$slots.code)?_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.expand),expression:"expand"}],staticClass:"db__code"},[_vm._t("code")],2):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/DemoBox.vue?vue&type=template&id=e571b3bc&
 ...
 */
function goJsfiddle(_ref, _ref2) {
  var html = _ref.html,
      script = _ref.script,
      style = _ref.style;
  var jsRes = _ref2.jsRes,
      cssRes = _ref2.cssRes;
  var htmlTpl = "<div id=\"app\">\n".concat(html, "\n</div>");
  var vmCode = script.replace(/export\s+default\s*/, '');
  var jsTpl = "var Ctor = Vue.extend(".concat(vmCode, ")\nnew Ctor().$mount('#app')");
  var resources = [].concat(_toConsumableArray(cssRes), _toConsumableArray(getJsResFiles(jsRes))).join(',');
  submitForm({
...
function goCodepen(_ref3, _ref4) {
  var html = _ref3.html,
      script = _ref3.script,
      style = _ref3.style;
  var jsRes = _ref4.jsRes,
      cssRes = _ref4.cssRes;
  var htmlTpl = "<div id=\"app\">\n".concat(html, "\n</div>");
  var vmCode = script.replace(/export\s+default\s*/, '');
  var jsTpl = "var Ctor = Vue.extend(".concat(vmCode, ")\nnew Ctor().$mount('#app')");
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/DemoBox.vue?vue&type=script&lang=js&
...
/* harmony default export */ var DemoBoxvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    finalRes: function finalRes() {
      // prettier-ignore
      var globalJsRes = (this.globalConfig.jsRes || []).filter(function (res) {
        return typeof res === 'string';
      });
      var validJsRes = this.jsRes.filter(function (res) {
        return typeof res === 'string';
      }); // prettier-ignore

      var globalCssRes = (this.globalConfig.CssRes || []).filter(function (res) {
        return typeof res === 'string';
      });
      var validCssRes = this.cssRes.filter(function (res) {
        return typeof res === 'string';
      });
      return {
        jsRes: Array.from(new Set([].concat(_toConsumableArray(globalJsRes), _toConsumableArray(validJsRes)))),
        cssRes: Array.from(new Set([].concat(_toConsumableArray(globalCssRes), _toConsumableArray(validCssRes))))
      };
    },
    finalPlatform: function finalPlatform() {
      var _this$globalConfig = this.globalConfig,
          jsfiddle = _this$globalConfig.jsfiddle,
          codepen = _this$globalConfig.codepen;
      return {
...
// CONCATENATED MODULE: ./src/DemoBox.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_DemoBoxvue_type_script_lang_js_ = (DemoBoxvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/DemoBox.vue
...
var component = normalizeComponent(
  src_DemoBoxvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var src = (DemoBox);
